...
pred_single_TwitterLDA <- function(w, doc_users, alphastar, betaV, bV, iterations, TOPICS, U, D, V, N, WY1ZX, Zstar, Yv1, WY0, result_folder) {
    invisible(.Call(`_mdtm_pred_single_TwitterLDA`, w, doc_users, alphastar, betaV, bV, iterations, TOPICS, U, D, V, N, WY1ZX, Zstar, Yv1, WY0, result_folder))
}

pred_all_TwitterLDA <- function(w, doc_users, alphastar, betaV, bV, iterations, TOPICS, U, D, V, N, WY1ZX, Zstar, Yv1, WY0, result_folder) {
    invisible(.Call(`_mdtm_pred_all_TwitterLDA`, w, doc_users, alphastar, betaV, bV, iterations, TOPICS, U, D, V, N, WY1ZX, Zstar, Yv1, WY0, result_folder))
}
